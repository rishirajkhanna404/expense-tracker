...
description: Runs parallel security and quality code 
  review for a specific spendwise feature. Pass the spec 
...
**spendwise-security-reviewer** receives:
...
**spendwise-quality-reviewer** receives:
- The combined diff from the pre-flight check
- Spec file for context: `.claude/specs/$ARGUMENTS.md`
...
Security Findings
[spendwise-security-reviewer output]
Quality Findings
[spendwise-quality-reviewer output]
