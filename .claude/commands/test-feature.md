---
description: Writes and runs tests for a specific spenwise feature. Pass the spec name as argument e.g. /test-feature 05-backend-connection
...
Invoke the **spenwise-test-writer** subagent with the 
following context:
...
Wait for spenwise-test-writer to fully complete and 
...
Once spenwise-test-writer has finished, invoke the 
**spenwise-test-runner** subagent with the following 
context:
...
- If spenwise-test-writer reports it could not write 
...
**Step 2 — Test Results**
- Mirror the spenwise-test-runner's structured report
